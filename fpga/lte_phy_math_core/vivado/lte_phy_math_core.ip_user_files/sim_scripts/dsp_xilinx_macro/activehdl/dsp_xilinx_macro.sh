...
#                script (type 'dsp_xilinx_macro.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/WorkPrograms/git-projects/srsRAN_4G/fpga/lte_phy_math_core/vivado/lte_phy_math_core.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
