...
#
# Script generated by Vivado on Sun Dec 07 17:16:06 +0300 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_xilinx_macro.sh
...
#
# Usage        : dsp_xilinx_macro.sh
#                dsp_xilinx_macro.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_xilinx_macro.sh [-reset_run]
#                dsp_xilinx_macro.sh [-reset_log]
#                dsp_xilinx_macro.sh [-help]
#
...
export RDI_DATADIR="C:/WorkPrograms/Engineering/Xilinx/Vivado/2024.2/data"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "dsp_xilinx_macro.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_xilinx_macro.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L secureip -L xpm --snapshot dsp_xilinx_macro xil_defaultlib.dsp_xilinx_macro -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_xilinx_macro -key {Behavioral:sim_1:Functional:dsp_xilinx_macro} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/WorkPrograms/Engineering/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_xilinx_macro.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_xilinx_macro.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_xilinx_macro.sh [-help]\n\
Usage: dsp_xilinx_macro.sh [-step]\n\
Usage: dsp_xilinx_macro.sh [-lib_map_path]\n\
Usage: dsp_xilinx_macro.sh [-reset_run]\n\
Usage: dsp_xilinx_macro.sh [-reset_log]\n\
Usage: dsp_xilinx_macro.sh [-keep_index]\n\
Usage: dsp_xilinx_macro.sh [-noclean_files]\n\n\
