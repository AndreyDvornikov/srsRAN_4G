...
REM
REM Generated by Vivado on Sun Dec 07 14:40:16 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj lte_phy_math_core_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lte_phy_math_core_vlog.prj -log xvlog.log
