...
/**
    ...
    старые наработки, имеющие новую жизнь
    смотреть https://dmitriymosk.yonote.ru/share/d520fd1d-ffa6-4e41-a07e-d4a0949f79de
*/
...
`define MAIN_FFT_CONTROL_RUN_WRITE_CONTROL_REG_ADDR_STATE       4'b1001     /* - start                                  */
`define MAIN_FFT_CONTROL_RUN_READ_STATUS_REG_ADDR_STATE         4'b1010     /* - wait int_o ждем конец работы fft       */
`define MAIN_FFT_CONTROL_FINISH_STATE                           4'b1011     /* - закончили                              */
...
module main_fft_control (
    ...
    // размерность слова при конфигурации bel fft
...
/* держим сигналы, пока slave не примет */              \
                    if (i_s_waitrequest == 1'b0) begin  \
/* на следующем такте отпускаем и шагаем дальше */      \
                        o_s_address    <= '0;           \
                        o_s_writedata  <= '0;           \
                        o_s_write      <= 1'b0;         \
                        o_s_byteenable <= '0;           \
